...
const zh = {
  ...
  subjectCenter: { learn: "学习中心", map: "思维导图", practice: "题库练习", wrong: "错题本", review: "复习", areas: "科目 / 模块", savedPoints: "已保存知识点", core: "核心概念", key: "重点", pitfalls: "易错点", ownNote: "我的笔记", mastery: "掌握状态", new: "未开始", learning: "学习中", reviewing: "复习中", mastered: "已掌握", lastStudy: "最近学习", due: "待复习", expand: "展开", collapse: "收起" },
  ...
  recitation: { title: "全科背诵", subtitle: "各科背诵内容与间隔复习。", add: "新增背诵材料", content: "背诵内容", today: "今日背诵", review: "待复习", mastered: "已掌握", start: "查看并背诵", complete: "完成", later: "稍后复习", subjectLink: "进入科目", center: "进入背诵中心", forgot: "完全不会", vague: "模糊", remembered: "基本记住", rateMastered: "已掌握" },
  knowledge: { title: "个人知识库", subtitle: "搜索、整理并关联你的长期笔记。", add: "新建笔记", content: "内容", link: "关联内容" },
  books: { title: "书籍", add: "添加书籍", author: "作者", want: "想读", reading: "阅读中", finished: "已读完", paused: "已暂停", progress: "阅读进度", rating: "评分", start: "开始日期", finish: "完成日期" },
  ...
  focus: { title: "专注", subtitle: "结束后记录学习时长；从任务启动时也会更新任务实际时长。", task: "关联任务（可选）", duration: "专注时长", custom: "自定义", start: "开始", pause: "暂停", resume: "继续", finish: "结束并记录", reset: "重置", idle: "准备开始", running: "正在专注", paused: "已暂停", saved: "已记录本次学习" },
...
const en: typeof zh = {
  ...
  recitation: { title: "Recitation Across Subjects", subtitle: "Recall material and spaced reviews for every subject.", add: "Add material", content: "Content", today: "Today's recitation", review: "Due", mastered: "Mastered", start: "View and recite", complete: "Complete", later: "Review later", subjectLink: "Open subject", center: "Open recitation center", forgot: "Forgot", vague: "Vague", remembered: "Mostly remembered", rateMastered: "Mastered" },
  ...
  books: { title: "Books", add: "Add book", author: "Author", want: "Want to read", reading: "Reading", finished: "Finished", paused: "Paused", progress: "Progress", rating: "Rating", start: "Start date", finish: "Finish date" },
  ...
  focus: { title: "Focus", subtitle: "Finishing saves study time; sessions started from a task also update that task.", task: "Linked task (optional)", duration: "Focus duration", custom: "Custom", start: "Start", pause: "Pause", resume: "Resume", finish: "Finish and save", reset: "Reset", idle: "Ready", running: "Focusing", paused: "Paused", saved: "Study session saved" },
